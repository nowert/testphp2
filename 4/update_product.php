...
if($_POST["button"]=="บันทึกการแก้ไข"){
	$sql3="update order_temp set order_pro_unit='".$_POST["prounit"]."' where order_temp_id='".$_SESSION["orderid"]."' and order_pro_id='".$_POST["pro_hid"]."' ";
...
<?php include("navbar.php"); ?>
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
        <input name="pro_hid" type="hidden" value="<?php echo $data["order_pro_id"]; ?>">
